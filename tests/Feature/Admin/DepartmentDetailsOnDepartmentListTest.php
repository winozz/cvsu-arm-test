...
test('department list can create a department using the modal form', function () {
...
test('department list warns before creating a department with an exact existing code under the same college', function () {
    $user = User::factory()->create();
    $user->assignRole('superAdmin');
...
test('department list warns and lists all similar existing entries for fuzzy code matches', function () {
    $user = User::factory()->create();
    $user->assignRole('superAdmin');
...
test('department list can update a department using the modal form', function () {
    $user = User::factory()->create();
    $user->assignRole('superAdmin');
...
test('department save confirmation closes the modal and can reopen on cancel', function () {
    $user = User::factory()->create();
    $user->assignRole('superAdmin');
...
test('department create confirmation closes the modal and can reopen on cancel', function () {
    $user = User::factory()->create();
    $user->assignRole('superAdmin');
