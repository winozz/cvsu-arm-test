...
describe('roles management', function () {
    ...
    it('roles page can create a role with permissions selected as string ids', function () {
    ...
    it('roles page can update a role with permissions selected as string ids', function () {
        $user = User::factory()->create();
        $user->assignRole('superAdmin');
