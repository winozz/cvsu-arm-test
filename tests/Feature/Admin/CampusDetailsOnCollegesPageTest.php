...
describe('admin colleges page campus details', function () {
    beforeEach(function () {
        Role::findOrCreate('superAdmin', 'web');
    });

    it('colleges page can update the current campus details', function () {
    ...
    it('save confirmation closes the campus modal and can reopen on cancel', function () {
        $user = User::factory()->create();
        $user->assignRole('superAdmin');
