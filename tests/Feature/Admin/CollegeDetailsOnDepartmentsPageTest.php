...
describe('admin departments page college details', function () {
    beforeEach(function () {
        Role::findOrCreate('superAdmin', 'web');
    });

    it('departments page can update the current college details', function () {
    ...
    it('save confirmation closes the college modal and can reopen on cancel', function () {
        $user = User::factory()->create();
        $user->assignRole('superAdmin');
