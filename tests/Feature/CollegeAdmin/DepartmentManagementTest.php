...
describe('college admin department management', function () {
    beforeEach(function () {
        $this->seed(PermissionSeeder::class);
        $this->seed(RoleSeeder::class);
    });

    it('college admin can create a department for their current college using the modal form', function () {
    ...
    it('college admin can soft delete a department from the departments table actions', function () {
        $campus = Campus::factory()->create();
        $college = College::factory()->forCampus($campus)->create();
        $department = Department::factory()->forCollege($college)->create([
            'code' => 'CAS-DEL',
    ...
    it('college admin can restore a trashed department from the departments table actions', function () {
        $campus = Campus::factory()->create();
        $college = College::factory()->forCampus($campus)->create();
        $department = Department::factory()->forCollege($college)->create([
            'code' => 'CAS-RESTORE',
