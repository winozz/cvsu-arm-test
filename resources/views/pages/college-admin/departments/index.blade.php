...
new class extends Component {
    ...
    protected function departmentLooksSimilar(Department $department): bool
    {
        ...
        return $this->codesLookSimilar($enteredCode, $existingCode) || $this->namesLookSimilar($enteredName, $existingName);
    }
    ...
    {
        $query = Department::query()->where('id', $id)->where('college_id', $this->college->id)->where('campus_id', $this->campus->id);
